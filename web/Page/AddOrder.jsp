     ...
     <div class="grid-container">
            ...
            <main class="main-container">
              <div class="main-title">
                <p class="font-weight-bold">Add Order</p>
              </div>

                    <div class="charts-card">
                            
                                <form method="post" action="../JSP/addOrder.jsp">
                                  <div class="user-details">
                                        <div class="input-box">
                                            <span class="txt-details">Curorder Id</span>
                                            <input type="text" name="cur_id" value="" >
                                        </div>
                                        <div class="input-box">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <%
                                                ...
                                                ResultSet r4 = s4.executeQuery("Select * from supplier");
                                            %>
                                            <select name="sp_name" >
                                             <%
                                                while (r4.next()) {
                                            %>
                                                <option><%=r4.getString("sp_name")%></option>
                                            <%}%>
                                            </select>
                                        </div>
                                         <div class="input-box">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <input type="text" id="amount" value="0" name="cur_amount">
                                        </div>
                                        <div class="input-box">
                                            <span class="txt-details">Discount</span>
                                            <input type="text" id="discount" value="0.0" name="cur_discount">
                                        </div>
                                        <div class="input-box">
