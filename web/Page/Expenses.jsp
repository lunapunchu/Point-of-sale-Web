     ...
     <div class="grid-container">
            ...
            <header class="header">
              <div class="header-left">
                ...
                <span class="top-text">Expenses</span>
              </div>
            ...
            <aside id="sidebar" class="sidebar">
              ...
              <ul>
                      ...
                      <li>
                          <a href="Expenses.jsp" class="active">
                ...
                <div class="charts-card">
                  ...
                  <div class="table">
                    <%
                        ...
                        if(id != null){
                             Sql = "Select * from expense where e_id='"+Integer.parseInt(id)+"'";
                        };
                   ...
                   <table class="content">
                        ...
                        <tbody>
                           <%
                             while (r.next()) {
                          %>
                          <form method="post" action="../JSP/expensePay.jsp">
                            <tr>
                                  <td><input hidden type="text" name="e_id" value="<%=r.getString("e_id")%>"><%=r.getString("e_id")%></td>
                                  <td><input hidden type="text" name="e_name" value="<%=r.getString("e_name")%>"><%=r.getString("e_name")%></td>
                                  <td><input hidden type="text" name="price" value="<%=r.getString("price")%>"><%=r.getString("price")%></td>
                                  <td><input type="submit" class="button" value="Payment"></input></td>
                            </tr>
                          </form>
                          <%
                            }
                    ...
                    <div class="lower">
                        ...
                        <div class="lower-right">
                            <a href="AddExpenses.jsp" class="button2">Add Expense</a>
                        </div>
                    </div>
