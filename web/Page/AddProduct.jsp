              ...
              <div class="main-title">
                <p class="font-weight-bold">Add Product</p>
                    ...
                    <div class="charts-card">
                                ...
                                <form method="post" action="../JSP/addProduct.jsp">
                                  <div class="user-details">
                                        ...
                                        <div class="input-box">
                                              <span class="txt-details">Group</span>
                                                  <%
                                                      ...
                                                      ResultSet r = s.executeQuery("Select * from productgroup");
                                                  %>
                                                  <select name="group" >
                                                     <%
                                                         while (r.next()) {
                                                     %>
                                                         <option><%=r.getString("g_name")%></option>
                                                     <%}%>
                                                  </select>
                                          </div>
                                         <div class="input-box">
                                            ...
                                            <%
                                                ...
                                                ResultSet r1 = s1.executeQuery("Select * from subgroup");
                                            %>
                                            <select name="subgroup" >
                                             <%
                                                while (r1.next()) {
                                            %>
                                                <option><%=r1.getString("s_name")%></option>
                                            <%}%>
                                            </select>
                                        </div>
                                        <div class="input-box">
                                        ...
                                        <div class="input-box">
                                            <span class="txt-details">Promotion</span>
                                            <%
                                                Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
                                                ...
                                                ResultSet r3 = s3.executeQuery("Select * from promotion");
                                            %>
                                            <select name="pm" >
                                             <%
                                                while (r3.next()) {
                                            %>
                                                <option><%=r3.getString("pm_name")%></option>
                                            <%}%>
                                            </select>
                                        </div>
