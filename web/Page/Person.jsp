                ...
                <div class="charts-card">
                  ...
                  <div class="table">
                    <%
                        ...
                        if(id != null){
                             sql = "Select * from profile where id='"+Integer.parseInt(id)+"'";
                        };
                   ...
                   <table class="content">
                        ...
                        <tbody>
                           <%
                             while (r.next()) {
                          %>
                          <form method="post" action="../JSP/deleteProfile.jsp">
                            <tr>
                                  ...
                                  <td><%=r.getString("tel")%></td>
                                  <td><%=r.getString("role")%></td>
                                  <td><%=r.getString("id_aumpher")%></td>
                                  <td><%=r.getString("id_graduate")%></td>
                                  <td><%=r.getString("id_title")%></td>
                                  <td><%=r.getString("id_province")%></td>
                    ...
                    <div class="lower">
                        ...
                        <div class="lower-right">
                            <a href="AddProfile.jsp" class="button2">Add New Profile</a>
                        </div>
                    </div>
