     ...
     <div class="grid-container">
            ...
            <header class="header">
              <div class="header-left">
                ...
                <span class="top-text">Promotion</span>
              </div>
            ...
            <aside id="sidebar" class="sidebar">
              ...
              <ul>
                      ...
                      <li>
                          <a href="Promotion.jsp" class="active">
                ...
                <div class="charts-card">
                  ...
                  <div class="table">
                    <%
                        ...
                        if(id != null){
                             Sql = "Select * from promotion where pm_id='"+Integer.parseInt(id)+"'";
                        };
                   ...
                   <table class="content">
                        ...
                        <tbody>
                           <%
                             while (r.next()) {
                          %>
                          <form method="post" action="../JSP/deletePromotion.jsp">
                            <tr>
                                  <td><input hidden type="text" name="pm_id" value="<%=r.getString("pm_id")%>"><%=r.getString("pm_id")%></td>
                                  <td><input hidden type="text" name="pm_name" value="<%=r.getString("pm_name")%>"><%=r.getString("pm_name")%></td>
                                  <td><input hidden type="text" name="discount" value="<%=r.getString("discount")%>"><%=r.getString("discount")%></td>
                    ...
                    <div class="lower">
                        ...
                        <div class="lower-right">
                            <a href="AddPromotion.jsp" class="button2">Add Promotion</a>
                        </div>
                    </div>
